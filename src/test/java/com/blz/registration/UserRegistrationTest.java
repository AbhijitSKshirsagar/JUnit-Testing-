...
public class UserRegistrationTest {
	...
	public void givenFirstName_WhenValid_ShouldReturnTrue() {
		...
		boolean result = valid.firstName("Abhi");
	...
	public void givenFirstName_WhenShort_ShouldReturnFalse() {
		RegexTest valid = new RegexTest();
		boolean result = valid.firstName("Ab");
	...
	public void LastName_WhenValid_ShouldReturnTrue() {
		RegexTest valid = new RegexTest();
		boolean result = valid.lastName("Kshirsagar");
	...
	public void password2_WhenNoUpCase_ShouldReturnFalse() {
		RegexTest valid = new RegexTest();
		boolean result = valid.password2("abcdhyup");
		Assert.assertEquals(false, result);
	}
